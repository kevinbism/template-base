<?php
global $cms, $action_be, $headerType;
...
$headerType = getHeaderTypeBasedOnGalleryType($galleryType);
...
// Check if $variable is iterable or an array to avoid errors
function ensure_iterable($variable)
{
    return is_iterable($variable) ? $variable : [];
}


function src($source, $array = [])
{
    global $cms;
...
function modBreadCrumb($return)
{
    ...
    $return .= "<li class='breadcrumbs-item'><a href='" . $cube->getLinkHome() . "'>Home</a></li>";
